...
public class SpeakAndSpell {
	...
	public static void main(String[] args) {
		...
		speak("how do you spell mandlebrot");
		

		// 2. Catch the user's answer in a String
		
String answer =JOptionPane.showInputDialog("please answer");
		// 3. If the user spelled the word correctly, speak "correct"
if(answer.equalsIgnoreCase("mandlebrot")) { answer= ("correct") ;}
		// 4. Otherwise say "wrong"

		// 5. repeat the process for other world
